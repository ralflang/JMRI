#!/bin/bash
# Create virtual serial port that connects to bridge TCP server
#
# Author: Ralf Lang (ralf.lang@ralf-lang.de)
# Copyright: (C) 2026 JMRI Community
#
# Usage: ./create-virtual-port.sh <virtual_port> <tcp_host> <tcp_port>
#
# Example: ./create-virtual-port.sh /dev/ttyVCOM0 localhost 15731
