# Create virtual COM port that connects to bridge TCP server
#
# Author: Ralf Lang (ralf.lang@ralf-lang.de)
# Copyright: (C) 2026 JMRI Community
#
# Usage: .\create-virtual-port.ps1 -VirtualPort COM99 -TcpHost localhost -TcpPort 15731
#
# Prerequisites:
#   Install com2tcp: winget install --id=Eterlogic.com2tcp -e
#
# Note: This requires a physical or com0com virtual COM port pair.
# For true virtual ports, see create-virtual-port-com0com.ps1
